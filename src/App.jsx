...
function App() {
  ...
  return (
    ...
    <Main1 ref={(el) => (sectionsRef.current[2] = el)} className="hidden" />
    <Main ref={(el) => (sectionsRef.current[3] = el)} className="hidden" />
    <Footer ref={(el) => (sectionsRef.current[4] = el)} className="hidden" />
